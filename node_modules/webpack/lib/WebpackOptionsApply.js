...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Zulnurain\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.453\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '2042343fa44407533e8aa2ARwLDB1XWwEDAVUGBlUAVQ0DVAVW', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Zulnurain/.vscode/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2042343fa44407533e8aa2ARwLDB1XWwEDAVUGBlUAVQ0DVAVW', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

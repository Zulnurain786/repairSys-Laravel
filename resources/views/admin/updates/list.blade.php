...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <a href="{{route('super-admin.updatesAdd')}}" class="btn btn-primary shadow-md mr-2">Add New Update</a>
    </div>
</div>
                ...
                @if($updates)
                    @foreach($updates as $key=>$val)
                        <tr>
                            ...
                            <td class="whitespace-nowrap">{{$val->version}}</td>
                            <td class="whitespace-nowrap">
                                <div class="flex">
                                    <a class="edit flex items-center mr-3" href="{{route('super-admin.updatesEdit',$val->id)}}">
                                    ...
                                    <a class="delete flex items-center text-danger" href="{{route('super-admin.updatesDelete',$val->id)}}" data-tw-toggle="modal" data-tw-target="#delete-modal-preview">

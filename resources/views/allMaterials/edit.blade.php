...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        ...
        <div class="intro-y box p-5">
            <form action="{{route($layout.'.materialsUpdate')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-span-12 grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="unitPrice" step=".01" name="price" type="number" class="form-control" value="{{$material->price}}" required>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
                        <div class="mt-3" style="display: flex; justify-content: end;">
                            <a href="{{route($layout.'.materials')}}" class="btn btn-light mt-4 mr-3">Cancel</a>

    ...
    <body class="main">
        ...
        <div class="mobile-menu md:hidden">
            ...
            <ul class="border-t border-white/[0.08] py-5 hidden">
                <li>
                    <a href="{{route(auth()->user()->role->name.'.home')}}" class="menu {{ request()->is('technician') ? 'menu--active' : ''}}">
                ...
                <li>
                    ...
                    <ul class="">
                        <li>
                            <a href="{{route('technician.repairs')}}" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> List </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('technician.repairsAdd')}}" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                ...
                <li>
                    <a href="{{route('technician.materials')}}" class="menu">
                        <div class="menu__icon"> <i data-lucide="box"></i> </div>
            ...
            <div class="h-full flex items-center">
                ...
                <nav aria-label="breadcrumb" class="-intro-x h-full mr-auto">
                    <ol class="breadcrumb breadcrumb-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ request()->path()=='technician' ? 'home' : substr(request()->path(), strpos(request()->path(), '/') + 1) }}</li>
                    </ol>
                </nav>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
                <div class="intro-x dropdown w-8 h-8">
                    ...
                    <div class="dropdown-menu w-56">
                        <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                            ...
                            <li>
                                <a href="{{route('technician.settings')}}" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> Profile </a>
                            </li>
                            <li>
                                <a href="{{route('technician.passwords')}}" class="dropdown-item hover:bg-white/5"> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                            </li>
                            <li>
                                <hr class="dropdown-divider border-white/[0.08]">
                            </li>
        ...
        <div class="wrapper">
            <div class="wrapper-box">
                ...
                <nav class="side-nav">
                    <ul>
                        <li>
                            <a href="{{route(auth()->user()->role->name.'.home')}}" class="side-menu {{ request()->is('technician') ? 'side-menu--active' : ''}}">
                        ...
                        <li>
                            <a href="javascript:;" class="side-menu {{ request()->is('technician/repairs/*') || request()->is('technician/repairs') ? 'side-menu--open' : ''}}">
                            ...
                            <ul class="{{ request()->is('technician/repairs/*') || request()->is('technician/repairs') ? 'side-menu__sub-open' : ''}}">
                                <li>
                                    <a href="{{route('technician.repairs')}}" class="side-menu {{ request()->is('technician/repairs') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                        <div class="side-menu__title"> List </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('technician.repairsAdd')}}" class="side-menu {{ request()->is('technician/repairs/add') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        ...
                        <li>
                            <a href="javascript:;" class="side-menu {{ request()->is('technician/materials/*') || request()->is('technician/materials') ? 'side-menu--open' : ''}}">
                                <div class="side-menu__icon"> <i data-lucide="box"></i> </div>
                                <div class="side-menu__title">
                                    Materials
                                    <div class="side-menu__sub-icon "> <i data-lucide="chevron-down"></i> </div>
                            ...
                            <ul class="{{ request()->is('technician/materials/*') || request()->is('technician/materials') ? 'side-menu__sub-open' : ''}}">
                                <li>
                                    <a href="{{route('technician.materials')}}" class="side-menu {{ request()->is('technician/materials') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                        <div class="side-menu__title"> List </div>
                                    </a>
                                </li>

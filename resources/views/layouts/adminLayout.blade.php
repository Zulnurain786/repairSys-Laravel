    ...
    <body class="main">
        ...
        <div class="mobile-menu md:hidden">
            ...
            <ul class="border-t border-white/[0.08] py-5 hidden">
                <li>
                    <a href="{{route(auth()->user()->role->name.'.home')}}" class="menu {{ request()->is('super-admin') ? 'menu--active' : ''}}">
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu__title"> Companies <i data-lucide="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="{{route('super-admin.companies')}}" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> List</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('super-admin.companiesAdd')}}" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon"> <i data-lucide="box"></i> </div>
                        <div class="menu__title"> Updates <i data-lucide="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="{{route('super-admin.updates')}}" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu__title"> List</div>
                            </a>
                        </li>
            ...
            <div class="h-full flex items-center">
                ...
                <nav aria-label="breadcrumb" class="-intro-x h-full mr-auto">
                    <ol class="breadcrumb breadcrumb-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ request()->path()=='super-admin' ? 'home' : substr(request()->path(), strpos(request()->path(), '/') + 1) }}</li>
                    </ol>
                </nav>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Account Menu -->
        ...
        <div class="wrapper">
            <div class="wrapper-box">
                ...
                <nav class="side-nav">
                    <ul>
                        <li>
                            <a href="{{route(auth()->user()->role->name.'.home')}}" class="side-menu {{ request()->is('super-admin') ? 'side-menu--active' : ''}}">
                        ...
                        <li>
                            <a href="javascript:;" class="side-menu {{ request()->is('super-admin/companies/*') || request()->is('super-admin/companies') ? 'side-menu--open' : ''}}">
                            ...
                            <ul class="{{ request()->is('super-admin/companies/*') || request()->is('super-admin/companies') ? 'side-menu__sub-open' : ''}}">
                                <li>
                                    <a href="{{route('super-admin.companies')}}" class="side-menu {{ request()->is('super-admin/companies') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                        <div class="side-menu__title"> List </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('super-admin.companiesAdd')}}" class="side-menu {{ request()->is('super-admin/companies/add') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        ...
                        <li>
                            <a href="javascript:;" class="side-menu {{ request()->is('super-admin/updates/*') || request()->is('super-admin/updates') ? 'side-menu--open' : ''}}">
                                <div class="side-menu__icon"> <i data-lucide="box"></i> </div>
                                <div class="side-menu__title">
                                    Updates
                                    <div class="side-menu__sub-icon "> <i data-lucide="chevron-down"></i> </div>
                            ...
                            <ul class="{{ request()->is('super-admin/updates/*') || request()->is('super-admin/updates') ? 'side-menu__sub-open' : ''}}">
                                <li>
                                    <a href="{{route('super-admin.updates')}}" class="side-menu {{ request()->is('super-admin/updates') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                        <div class="side-menu__title"> List </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('super-admin.updatesAdd')}}" class="side-menu {{ request()->is('super-admin/updates/add') ? 'side-menu--active' : ''}}">
                                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                        <div class="side-menu__title"> Add New </div>
                                    </a>
                                </li>
       ...
       <script src="https://cdn.tiny.cloud/1/0h26lq50sxa1tavvq54lvi1s59wl4ixb4nvhtzbmy93udqik/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
       <script>
        tinymce.init({
          selector: '.editor',

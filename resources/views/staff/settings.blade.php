...
<div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
        <div class="intro-y box mt-5">
            ...
            <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                <a class="flex items-center {{request()->is('staff/settings') ? 'text-primary font-medium' : ''}}" href="{{route('staff.settings')}}"> <i data-lucide="activity" class="w-4 h-4 mr-2"></i> Personal Information </a>
                <a class="flex items-center mt-5 {{request()->is('staff/passwords') ? 'text-primary font-medium' : ''}}" href="{{route('staff.passwords')}}"> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Change Password </a>
            </div>
    ...
    <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
        ...
        <div class="intro-y box lg:mt-5">
            ...
            <div class="p-5">
                <form data-single="true" method="POST" enctype="multipart/form-data" data-file-types="image/jpeg|image/png|image/jpg" action="{{route('staff.uploadProfile')}}" class="dropzone">
                    <div>
                        @csrf
                        <div class="fallback"> 
           ...
           <div class="p-5">
                <form action="{{route('staff.uploadProfileData')}}" method="post" id="formData">
                    @csrf
                    <div class="mt-3">

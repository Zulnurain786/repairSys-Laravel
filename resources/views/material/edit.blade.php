                ...
                <div class="col-span-12 grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
                        <div class="mt-3">
                            ...
                            <input id="unitPrice" name="unit_price" step=".01" type="number" class="form-control" value="{{$material->price/$material->qty}}" required>
                        </div>
                        <div class="mt-3">
                            <label for="change-password-form-3" class="form-label">Total Price £</label>
                            <input id="total" name="price" step=".01" type="number" class="form-control" value="{{$material->price}}" required readonly>
                        </div>
